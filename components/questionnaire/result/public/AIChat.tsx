      ...
      const messageHistory = [
        {
          role: 'system',
          content: lang === 'ru'
            ? `Ассистент по психическому здоровью, отвечай на основе результатов ${questionnaireType} ${JSON.stringify(questionnaireResults)}. На русском языке, дружелюбно и поддерживающе, без медицинского диагноза, кратко.`
            : `Psixi sağlamlıq assistenti, ${questionnaireType} nəticələrinə ${JSON.stringify(questionnaireResults)} əsaslanaraq cavab ver. Azərbaycan dilində, dostyana və dəstəkləyici, tibbi diaqnoz qoymadan, qısa cavab ver.`
        },
        ...messages,
        userMessage
      ];
